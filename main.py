...
parser.add_argument('--dataroot', default='./resources/imagenet_full/ILSVRC/Data/CLS-LOC/train/', help='path to dataset')
...
parser.add_argument('--netG', default='./imagenet_model/netG_epoch_2.pth', help="path to netG (to continue training)")
