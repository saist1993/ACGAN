...
parser.add_argument('--dataroot', default='./resources/lsun/', help='path to dataset')
...
parser.add_argument('--outf', default='./church_generation', help='folder to output images and model checkpoints')
